...
(function (app) {
  'use strict';
})(require('angular').module('app', [require('angular-ui-router'),
// 'app.views',
'app.bidule', 'app.services', 'app.config']));
;'use strict';
...
(function (app) {})(angular.module('app.config', []));
;'use strict';
